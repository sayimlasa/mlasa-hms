                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('location.create')}}" >Add Location</a></li>
                                    ...
                                    <td>
                                        <div class="btn-group hstack gap-3">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="{{route('location.edit',$location->id)}}"><i class="fa fa-edit"></i></a>
                                                <form action="" method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button class="dropdown-item"><i
                                                            class="ri-lock-unlock-line fa fa-trash-alt"></i> Delete
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
