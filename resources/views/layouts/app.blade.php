...
<head>
    ...
    <title>{{ config('app.name', 'mlasa hms') }}</title>
...
<script>
    $(() => {
        @if(session('success'))
        triggerSuccess(`{{session('success')}}`, `{{session('delay')}}`);
        @endif
        @if(session('error'))
        triggerError(`{{session('error')}}`, `{{session('delay')}}`);
        @endif
        @if(session('warning'))
        triggerError(`{{session('warning')}}`, `{{session('delay')}}`);
        @endif
