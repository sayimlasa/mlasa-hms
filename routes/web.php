...
Route::post('/patient/delete',[PatientController::class,'destroy'])->name('patient.destroy');
Route::get('/patient/patient',[PatientController::class,'view'])->name('patient.view');
...
Route::post('/consultation/store',[Appointment::class,'store'])->name('consultation.store');
Route::get('/patient/active',[PatientController::class,'active'])->name('patient.active');
//doctor

Route::get('/doctor',[DoctorController::class,'index'])->name('doctor.index')->middleware('doctor');
Route::get('/doctor/assessment/{id}',[DoctorController::class,'show'])->name('doctor.form');
Route::post('assessment-form',[DoctorController::class,'save'])->name('assessment.save');
Route::get('/patient/assessment',[DoctorController::class,'save'])->name('patients.form');
Route::get('/patientfromtechnician',[DoctorController::class,'patientfromtechnician'])->name('technicianform');
//reception
...
Route::get('/technician/assessment/{id}',[TechnicianController::class,'show'])->name('technician.form');
Route::post('/technician/assessment/save',[TechnicianController::class,'save'])->name('technician.save');
//nurse
